...
# make plist
$ACK_PLIST_EXE $PROJECT_ROOT_PATH $OUTPUT_PLIST_PATH --manual-plist-path $MANUAL_ACK_PATH

# make bundle
$ACK_PLIST_EXE $PROJECT_ROOT_PATH  $OUTPUT_BUNDLE_PATH --manual-plist-path $MANUAL_ACK_PATH
